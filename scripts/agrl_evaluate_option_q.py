...
from maze_gpt_agent.agrl_option_q import load_model, run_option_strategy
...
def main():
    ...
    parser.add_argument('--model', default='artifacts/agrl_oracle_ratio_15/option_q.pt')
    parser.add_argument('--out', default='artifacts/agrl_oracle_ratio_15/evaluation_option_q.json')
    parser.add_argument('--html', default='artifacts/agrl_oracle_ratio_15/demo_option_q.html')
    ...
    for idx, sample in enumerate(samples, 1):
        result = run_option_strategy(sample, model)
    ...
    if demo:
        render_run_html(args.html, 'AGRL-Maze Termination-Aware OptionQ Demo', demo.frames, demo.summary())
