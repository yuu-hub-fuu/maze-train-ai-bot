"""Compatibility LoRA/SFT trainer for the remote AlphaMaze run.

This keeps the same course-maze data format as hf_lora_train_alpha_maze.py, but
adapts at runtime to older/newer TRL argument names on the GPU server.
"""
